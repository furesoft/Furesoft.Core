...
namespace Nova.CodeDOM
{
    ...
    public class Mod : BinaryArithmeticOperator
    {
        ...
        /// <summary>
        /// Calculate the mod (remainder) of two constant objects.
        /// Supported types are: string, bool, enum, decimal, double, float, ulong, long, uint, int, ushort, short, char, byte, sbyte.
        /// </summary>
        /// <returns>
        /// The remainder of the division of the two constants, using the appropriate result type, including promoting smaller
