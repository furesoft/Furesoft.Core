...
{
    internal class FacultyOperator : PostUnaryOperator
    {
        private const int Precedence = 2;

        public FacultyOperator(Parser parser, CodeObject parent) : base(parser, parent)
        {
        }
        ...
        public static FacultyOperator Parse(Parser parser, CodeObject parent, ParseFlags flags)
        {
            ...
            if (parser.HasUnusedExpression)
                return new FacultyOperator(parser, parent);
            return null;
        }
