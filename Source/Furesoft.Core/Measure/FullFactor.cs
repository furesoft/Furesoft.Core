...
/// <summary>
///     Immutable struct that captures <see cref="Factor" />.2^<see cref="ExpFactor.Exp2" />.10^
///     <see cref="ExpFactor.Exp10" />.
/// </summary>
public readonly struct FullFactor : IEquatable<FullFactor>
{
    ...
    public FullFactor Power(int p)
    {
        return new(Math.Pow(Factor, p), ExpFactor.Power(p));
    }
    ...
    public FullFactor Multiply(FullFactor x)
    {
        return new(Factor * x.Factor, ExpFactor.Multiply(x.ExpFactor));
    }
    ...
    /// <returns>The resulting full factor.</returns>
    public FullFactor DivideBy(FullFactor x)
    {
        return new(Factor / x.Factor, ExpFactor.DivideBy(x.ExpFactor));
    }
    ...
    {
        return Factor * ExpFactor.ToDouble();
    }
    ...
    public override string ToString()
    {
        ...
        return Factor + ExpFactor.ToString('*');
    }

#pragma warning disable 1591
    public static implicit operator FullFactor(double d)
    {
        return new(d);
    }

    public static implicit operator FullFactor(ExpFactor e)
    {
        return new(e);
    }

    public static bool operator ==(FullFactor f1, FullFactor f2)
    {
        return f1.Equals(f2);
    }
    ...
    public static bool operator ==(FullFactor f1, ExpFactor e2)
    {
        return f1.Equals(e2);
    }
    ...
    public static bool operator ==(ExpFactor e1, FullFactor f2)
    {
        return f2.Equals(e1);
    }
...
#pragma warning restore 1591
    ...
    {
        return (obj is FullFactor f && Equals(f))
    ...
    /// <returns>True if this full factor is the same as the other one. False otherwise.</returns>
    public bool Equals(FullFactor other)
    {
        return Factor == other.Factor && ExpFactor.Equals(other.ExpFactor);
    }
    ...
    public bool Equals(ExpFactor other)
    {
        return Factor == 1.0 && ExpFactor.Equals(other);
    }
    ...
    {
        return Factor.GetHashCode() ^ ExpFactor.GetHashCode();
    }
}