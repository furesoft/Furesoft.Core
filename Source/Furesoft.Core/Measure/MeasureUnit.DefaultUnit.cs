...
public partial class MeasureUnit
{
    ...
    /// </summary>
    public static FundamentalMeasureUnit None = new(null, "", "None", AutoStandardPrefix.None, true);
    ...
    public static bool TryParse(string text, out MeasureUnit u)
    {
        return StandardMeasureContext.Default.TryParse(text, out u);
    }
}