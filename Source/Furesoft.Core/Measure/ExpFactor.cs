...
public struct ExpFactor : IComparable<ExpFactor>, IEquatable<ExpFactor>
{
    ...
    public ExpFactor Power(int p)
    {
        return new(Exp2 * p, Exp10 * p);
    }
    ...
    public ExpFactor Multiply(ExpFactor x)
    {
        return new(Exp2 + x.Exp2, Exp10 + x.Exp10);
    }
    ...
    public ExpFactor DivideBy(ExpFactor x)
    {
        return new(Exp2 - x.Exp2, Exp10 - x.Exp10);
    }
    ...
    {
        return Math.Pow(2, Exp2) * Math.Pow(10, Exp10);
    }
    ...
    {
        return obj is ExpFactor f && Equals(f);
    }
    ...
    {
        return Exp2 == other.Exp2 && Exp10 == other.Exp10;
    }
