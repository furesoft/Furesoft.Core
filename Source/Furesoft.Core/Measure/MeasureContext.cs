...
public partial class MeasureContext
	{
		...
		private AliasMeasureUnit RegisterAlias(string a, string n, FullFactor f, MeasureUnit d, AutoStandardPrefix stdPrefix)
		{
		...
		private FundamentalMeasureUnit RegisterFundamental(string abbreviation, string name, AutoStandardPrefix stdPrefix, bool isNormalized)
		{
