...
///         Introspecting Class1 return a ClassInfoList with the classes Class1, Class2, Class3. Class1 being the main
///         class info
///     </pre>
/// </remarks>
public sealed class ClassInfoList
{
    ...
    {
        _classInfosByType.TryGetValue(type, out var classInfo);
        return classInfo;
    }
