...
public sealed class ClassInfo
{
    ...
    {
        _attributes = null;
        OriginalZoneInfo = new();
        CommitedZoneInfo = new();
        UncommittedZoneInfo = new();
        _oidInfo = new();
        Position = -1;
        MaxAttributeId = -1;
    ...
    {
        UnderlyingType = CheckIfTypeIsInstantiable(fullClassName);
    ...
    /// </summary>
    internal CommittedCIZoneInfo CommitedZoneInfo { get; }
    ...
    public int NumberOfAttributes => _attributes.Count;
