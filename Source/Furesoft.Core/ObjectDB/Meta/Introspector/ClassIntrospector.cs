...
internal static class ClassIntrospector
{
    ...
    /// <summary>
    ///     introspect a list of classes This method return the current meta model based on the classes that currently exist in
    ///     the execution classpath.
    /// </summary>
    /// <remarks>
    ///     introspect a list of classes This method return the current meta model based on the classes that currently exist in
    ///     the execution classpath.
    ///     The result will be used to check meta model compatibility between the meta model that is currently persisted in the
    ///     database and the meta
