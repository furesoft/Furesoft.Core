...
internal sealed class GenericArgumentsHolder
{
    ...
    public bool ContainsGenericArguments =>
        _unresolvedGenericArguments != null &&
    ...
    /// </summary>
    public bool IsArrayDeclaration => _arrayDeclaration != null;
    ...
    /// <summary>
    ///     Tokenize the given <see cref="string" /> into a
    ...
    ///         <see cref="string" />, returns a <see cref="string" /> array with one
    ///         element: <paramref name="s" /> itself.
    ///     </p>
    /// </remarks>
    /// <param name="s">
    ///     The <see cref="string" /> to tokenize.
    /// </param>
    /// <param name="delimiters">
    ///     The delimiter characters, assembled as a <see cref="string" />.
    /// </param>
    /// <param name="trimTokens">
    ///     Trim the tokens via <see cref="string.Trim()" />.
    /// </param>
