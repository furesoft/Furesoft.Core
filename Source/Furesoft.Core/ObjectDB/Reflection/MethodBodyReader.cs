...
internal sealed class MethodBodyReader
{
    ...
    private void ReadOperand(Instruction instruction)
    {
        switch (instruction.OpCode.OperandType)
        {
            ...
            case OperandType.InlineSwitch:
            {
                ...
                for (var i = 0; i < num; i++) numArray[i] = _il.ReadInt32() + num2;
    ...
    private void ResolveBranches()
    {
        foreach (var instruction in _instructions)
        {
            ...
            {
                if (operandType == OperandType.InlineSwitch) goto Label_005A;
            ...
            for (var i = 0; i < numArray.Length; i++) instructionArray[i] = GetInstruction(_instructions, numArray[i]);
