...
namespace Furesoft.Core.ObjectDB.Exceptions;
	...
	internal sealed class NDatabaseError : IError
	{
		...
		internal static readonly NDatabaseError NegativePosition = new(261, "Error during seek operation, position. Negative position : @1");
		...
		internal static readonly NDatabaseError FileNotFoundOrItIsAlreadyUsed = new(291, "File not found or it already used: @1");
