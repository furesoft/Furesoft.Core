...
/// </summary>
/// <remarks>
///     An action to retrieve a sublist of list. It is used by the Object Values API. When calling odb.getValues(new
///     ValuesCriteriaQuery(Handler.class, Where .equal("id", id)).sublist("parameters",fromIndex, size); The sublist
///     action will return Returns a view of the portion of this list between the specified fromIndex, inclusive, and
///     toIndex, exclusive. if parameters list contains [param1,param2,param3,param4], sublist("parameters",1,2) will
///     return a sublist containing [param2,param3]
/// </remarks>
internal sealed class SublistAction : AbstractQueryFieldAction
{
    ...
    public SublistAction(IInternalQuery query, string attributeName, string alias, int fromIndex, int size,
        bool throwExceptionIfOutOfBound)
