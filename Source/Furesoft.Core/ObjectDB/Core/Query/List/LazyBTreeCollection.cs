...
/// </summary>
/// <remarks>
///     A collection using a BTtree as a back-end component. Lazy because it only keeps the oids of the objects. When asked
///     for an object, loads it on demand and returns it
/// </remarks>
