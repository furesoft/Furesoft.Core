...
/// </summary>
/// <remarks>
///     A simple list to hold query result. It is used when no index and no order by is used and inMemory = false This
///     collection does not store the objects, it only holds the OIDs of the objects. When user ask an object the object is
///     lazy loaded by the getObjectFromId method
/// </remarks>
internal sealed class LazySimpleListFromOid<T> : OdbList<T>, IInternalObjectSet<T>
{
    ...
    public new int Count => _oids.Count;
