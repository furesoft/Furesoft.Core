...
internal sealed class QueryConstraint : IInternalConstraint
{
    ...
    {
        return _evaluation is ComparisonEvaluation evaluation &&
               evaluation.ComparisonType == ComparisonConstraint.ComparisonTypeGt;
    }

    private bool IsPreEvaluationTheSmaller()
    {
        return _evaluation is ComparisonEvaluation evaluation &&
               evaluation.ComparisonType == ComparisonConstraint.ComparisonTypeLt;
    }
    ...
    {
        return _evaluation is EqualsEvaluation equalsEvaluation
    ...
    #endregion IInternalConstraint Members
}