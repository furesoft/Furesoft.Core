...
/// </summary>
/// <remarks>
///     Class that manage normal query. Query that return a list of objects. For each object That matches the query
///     criteria, the objectMatch method is called and it keeps the objects in the 'objects' instance.
/// </remarks>
