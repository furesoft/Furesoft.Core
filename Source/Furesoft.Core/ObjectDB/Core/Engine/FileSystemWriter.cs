...
internal sealed class FileSystemWriter : IFileSystemWriter
{
    ...
    {
        FileSystemInterface.SetWritePosition(StorageEngineConstant.DatabaseHeaderLastCloseStatusPosition,
            writeInTransaction);
    ...
    {
        FileSystemInterface.SetWritePosition(StorageEngineConstant.DatabaseHeaderNumberOfClassesPosition,
            writeInTransaction);
        ...
        long previousBlockPosition, bool writeInTransaction)
    {
        ...
        FileSystemInterface.SetWritePosition(StorageEngineConstant.DatabaseHeaderCurrentIdBlockPosition,
            writeInTransaction);
    ...
    {
        FileSystemInterface.SetWritePosition(blockPosition + StorageEngineConstant.BlockIdOffsetForBlockStatus,
            writeInTransaction);
        FileSystemInterface.WriteByte(BlockStatus.BlockFull, writeInTransaction);
        FileSystemInterface.SetWritePosition(blockPosition + StorageEngineConstant.BlockIdOffsetForNextBlock,
            writeInTransaction);
    ...
    public void CreateEmptyDatabaseHeader(IStorageEngine storageEngine, long creationDate)
    {
        ...
        FileSystemInterface.WriteLong(StorageEngineConstant.DatabaseHeaderFirstIdBlockPosition,
            false); // current id block position
        ...
        bool writeInTransaction)
    {
        ...
        FileSystemInterface.SetWritePosition(idPosition + StorageEngineConstant.BlockIdRepetitionIdStatus,
            writeInTransaction);
    ...
    /// <summary>
    ///     Updates the instance related field of the class info into the database file Updates the number of objects, the
    ///     first object oid and the next class oid
    /// </summary>
