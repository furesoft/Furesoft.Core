...
internal sealed class FileSystemInterface : IFileSystemInterface
{
    ...
    /// <summary>
    ///     Reserve space in the file when it is at the end of the file Used in transaction mode where real write will happen
    ///     later
    /// </summary>
    ...
    private void WriteValue<TValue>(TValue value, bool writeInTransaction, Func<TValue, byte[]> convert,
        OdbType odbType)
    {
    ...
    #endregion IFileSystemInterface Members
}