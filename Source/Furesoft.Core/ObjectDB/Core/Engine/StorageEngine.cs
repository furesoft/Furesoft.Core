...
///     The storage Engine
///     <pre>
///         The Local Storage Engine class in the most important class in ODB. It manages reading, writing and querying
///         objects.
...
internal sealed class StorageEngine : AbstractStorageEngineReader
{
    ...
    /// <summary>
    ///     This is a visitor used to execute some specific action(like calling 'Before Insert Trigger') when introspecting an
    ///     object
    /// </summary>
    ...
    public StorageEngine(IDbIdentification parameters)
    {
        ...
        try
        {
            ...
            var shouldUpdate =
                metaModelCompabilityChecker.Check(ClassIntrospector.Instrospect(metaModel.GetAllClasses()),
                    GetMetaModel());
