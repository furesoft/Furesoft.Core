...
internal sealed class NonNativeObjectWriter : INonNativeObjectWriter
{
        ...
        bool writeDataInTransaction, bool isNewObject)
    {
        ...
        _objectWriter.FileSystemProcessor.FileSystemInterface.SetWritePosition(attributePositionStart,
        ...
        _objectWriter.FileSystemProcessor.FileSystemInterface.WriteBytes(abytes, writeDataInTransaction);
        _objectWriter.FileSystemProcessor.FileSystemInterface.SetWritePosition(positionAfterWrite,
            writeDataInTransaction);
    ...
    private static void ManageIndexesForUpdate(OID oid, NonNativeObjectInfo nnoi,
