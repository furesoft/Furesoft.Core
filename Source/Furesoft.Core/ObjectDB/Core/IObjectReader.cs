...
public interface IObjectReader
{
    ...
    ///         readObjectInfoValues(classinfo,18000,true,[&quot;profile.name&quot;,&quot;profile.email&quot;],[&quot;
    ...
    ///     The names of attributes to read the values, an attributename can contain relation like
    ///     profile.name
    /// </param>
    ...
    /// </summary>
    /// <remarks>
    ///     Return Objects. Match the query without instantiating objects. Only instantiate object for object that match the
    ///     query
    /// </remarks>
    ...
    /// </summary>
    /// <param name="oid">
    ///     The oid of the object to get the position To indicate if an exception must be thrown if object is
    ///     not found
    /// </param>
    /// <param name="useCache"> </param>
