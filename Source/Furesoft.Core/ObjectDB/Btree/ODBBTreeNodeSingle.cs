...
/// </summary>
/// <remarks>
///     The NDatabase ODB BTree Node implementation. It extends the DefaultBTreeNode generic implementation to be able to
///     be stored in the ODB database.
/// </remarks>
internal sealed class OdbBtreeNodeSingle : BTreeNodeSingleValuePerKey
{
    ...
    ///     lazy loaded
    /// </summary>
    [NonPersistent] private IBTreeNode _parent;
